...
import { activePartyHandler, deactivePartyHandler, updatedPartyViewUploadHandler, updatePartyAllowDownloadHandler, updatePartyAllowMediaHandler, updatePartyManualApprovalHandler, updatePartyShowBrandHandler, updatePartySlideShowQRHandler, updatePartyThemeColorHandler, } from "../../party/controllers/partySettingsHandler.js";
export var partySettingsRoute = Router();
...
partySettingsRoute.post("/updateManualApproval", updatePartyManualApprovalHandler);
...
partySettingsRoute.post("/updateAllowDownload", updatePartyAllowDownloadHandler);
