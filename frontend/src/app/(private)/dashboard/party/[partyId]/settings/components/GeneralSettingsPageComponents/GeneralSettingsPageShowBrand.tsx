...
import useUpdateShowBrand from "../../mutations/GeneralSettingsPageMutations/useUpdateShowBrand";

function GeneralSettingsPageShowbrand({ partyData }: { partyData: Party }) {
...
export default GeneralSettingsPageShowbrand;
