...
import ApperanceEditDesignFooter from "./ApperanceEditDesignFooter";

interface ApperanceEditDesignModal {
  formData: Party;
...
function ApperanceEditDesignModal({
  formData,
  setFormData,
  mutation,
  progress,
...
export default ApperanceEditDesignModal;
