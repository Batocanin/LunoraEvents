...
import ApperancePageEditDesignPreview from "./ApperancePageEditDesignPreview";
import ApperancePageEditDesignForm from "./ApperancePageEditDesignForm";
...
function ApperancePageEditDesignEditor({
  form,
  formData,
  setFormData,
}: PartyPropsForm) {
  ...
  return (
    <div className="overflow-y-auto h-full space-y-6">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
        ...
        />
        <ApperancePageEditDesignPreview
          partyData={formData}
...
export default ApperancePageEditDesignEditor;
