...
import useUpdateManualApproval from "../../mutations/AdminSettingsPageMutations/useUpdateManualApproval";
import PartySettingsUpgradePlanDialog from "../PartySettingsUpgradePlanDialog";

function AdminSettingsPageManualApproval({ partyData }: { partyData: Party }) {
...
export default AdminSettingsPageManualApproval;
