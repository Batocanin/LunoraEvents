...
interface ApperancePageEditDesignFormProps {
...
function ApperancePageEditDesignForm({
  form,
  formData,
  setFormData,
  setMainPhotoUrl,
  setBackgroundPhotoUrl,
}: ApperancePageEditDesignFormProps) {
  useEffect(() => {
...
export default ApperancePageEditDesignForm;
