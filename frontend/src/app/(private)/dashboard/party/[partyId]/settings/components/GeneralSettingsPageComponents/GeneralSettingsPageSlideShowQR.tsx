...
import useUpdateSlideShowQR from "../../mutations/GeneralSettingsPageMutations/useUpdateSlideShowQR";

function GeneralSettingsPageSlideShowQR({ partyData }: { partyData: Party }) {
...
export default GeneralSettingsPageSlideShowQR;
