...
import ApperancePageEditDesignModal from "./ApperancePageEditDesignModal";
import useApperanceEditPartyMutation from "../../mutations/ApperancePageMutations/useApperanceEditPartyMutation";

function ApperancePageEditButton({ partyData }: { partyData: Party }) {
...
export default ApperancePageEditButton;
