...
interface ApperancePageEditDesignFooterProps {
...
function ApperancePageEditDesignFooter({
  form,
  mutation,
  currentStep,
  setCurrentStep,
  progress,
}: ApperancePageEditDesignFooterProps) {
...
export default ApperancePageEditDesignFooter;
